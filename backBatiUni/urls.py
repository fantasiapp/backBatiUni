...
urlpatterns = [
    ...
    path('create-payment-intent/', views.CreatePaymentIntent.as_view(), name='payment'),
    path('create-payment-checkout/', views.CreatePaymentCheckout.as_view(), name='payment_checkout')
]
