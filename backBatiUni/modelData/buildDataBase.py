...
class CreateNewDataBase:
  listTable = {"Company":Company, "Recommandation":Recommandation, "BlockedCandidate":BlockedCandidate, "Notification":Notification, "File":File, "Supervision":Supervision, "ViewPost":ViewPost, "FavoritePost":FavoritePost, "InviteFriend":InviteFriend, "UserProfile":UserProfile, "JobForCompany":JobForCompany, "LabelForCompany":LabelForCompany, "Disponibility":Disponibility,"Candidate":Candidate, "DetailedPost":DetailedPost, "DatePost":DatePost, "Supervision":Supervision, "Post":Post, "Job":Job, "Role":Role, "Label":Label}
  dictLabels = {
    ...
    "Quali'Eau":["qualiEau", "Ce label est destiné aux plombiers chauffagistes. C’est depuis 2003 que la réglementation impose cette certification. En effet, les conditions sanitaires d’installation de l’eau potable doivent être respectées pour éviter la multiplication des microbes comme la légionellose. Aussi, Quali’eau délivre des certifications portant sur trois grands axes : Enjeux et contexte réglementaire, maîtrise des techniques de conception de réseaux, Maîtrise des techniques de maintenance.", "https://www.capeb-paysdelaloire.fr/fich/qualieau.htm#demarche", True],
    "Quali'Sol":["qualiSol", "Label attribué pour la qualité de l’installation des systèmes à énergie renouvelable particulièrement dans le domaine du solaire. Les équipements concernés sont : les Chauffe-eau Solaires Individuels (CESI), les Systèmes Solaires Combinés (SSC)", "https://www.qualit-enr.org/decouvrir-nos-qualifications-rge/", True],
    "Quali'PV":["qualiPV", "Rassurez-vous, ceci n’est pas le sigle de la certification des contractuelles pour les autoriser à mettre des PV, mais bien le label destiné à la qualification des installations d’énergie renouvelable par les systèmes photovoltaïques.",	"https://www.qualit-enr.org/decouvrir-nos-qualifications-rge/", True],
    "Quali'Forage":["qualiForage", "Ce label est attribué au professionnel installant des forages géothermiques sur nappe.",	"https://www.qualit-enr.org/decouvrir-nos-qualifications-rge/", True],
    "Quali'Bois":["qualiBois", "La certification est attribuée aux professionnels habilités à installer des chauffages au bois dans les habitations.",	"https://www.qualit-enr.org/decouvrir-nos-qualifications-rge/", True],
    "Quali'Pac":["qualiPac", "pour l’installation de pompes à chaleur",	"https://www.qualit-enr.org/decouvrir-nos-qualifications-rge/é", True],
