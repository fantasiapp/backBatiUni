...
def executeQuery():
  ...
  if query in ["emptyDB", "buildDB"]:
    ...
    if query == "getUserData":
      ...
      post3 = {'action':"uploadPost", "longitude":2.326881 , "latitude":48.841626, "address":"36 rue Dauphine 75006 Paris", "Job":10, "numberOfPeople":1, "dueDate":f"2022-{nextMonth}-15", "startDate":f"2022-{nextMonth}-15", "endDate":f"2022-{nextMonth}-18", "DatePost":[f"2022-{nextMonth}-15", f"2022-{nextMonth}-16", f"2022-{nextMonth}-17", f"2022-{nextMonth}-18"], "manPower":True, "counterOffer":True, "hourlyStart":"07:00", "hourlyEnd":"17:00", "currency":"€", "description":"troisième description d'un chantier", "amount":12345.10, "DetailedPost":["doublage", "cloison"]}
      post4 = {'action':"uploadPost", "longitude":2.325883 , "latitude":48.841627, "address":"28 rue de Fleurus 75006 Paris", "Job":10, "numberOfPeople":2, "dueDate":f"2022-{nextMonth}-18", "startDate":f"2022-{nextMonth}-16", "endDate":f"2022-{nextMonth}-28", "DatePost":[f"2022-{nextMonth}-21", f"2022-{nextMonth}-22", f"2022-{nextMonth}-23"], "manPower":True, "counterOffer":False, "hourlyStart":"07:00", "hourlyEnd":"17:00", "currency":"€", "description":"quatrième description d'un chantier", "amount":1300.10, "DetailedPost":["doublage", "cloison", "pose", "mesure"]}
      post5 = {'action':"uploadPost", "longitude":2.325885 , "latitude":48.841628, "address":"34 rue Guynemer 75006 Paris", "Job":10, "numberOfPeople":1, "dueDate":f"2022-{nextMonth}-21", "startDate":f"2022-{nextMonth}-16", "endDate":f"2022-{nextMonth}-28", "DatePost":[f"2022-{nextMonth}-16", f"2022-{nextMonth}-17", f"2022-{nextMonth}-18"], "manPower":True, "counterOffer":False, "hourlyStart":"08:00", "hourlyEnd":"17:00", "currency":"€", "description":"cinquième description d'un chantier", "amount":1300.10, "DetailedPost":["cuisine", "salle de bain", "salon", "Chambre"]}
      post6 = {'action':"uploadPost", "longitude":2.324877 , "latitude":48.841625, "address":"108 rue du Cherche-Midi 75006 Paris", "Job":5, "numberOfPeople":1, "dueDate":f"2022-{nextMonth}-15", "startDate":f"2022-{nextMonth}-16", "endDate":f"2022-{nextMonth}-28", "DatePost":[f"2022-{nextMonth}-26", f"2022-{nextMonth}-27", f"2022-{nextMonth}-28"], "manPower":False, "counterOffer":True, "hourlyStart":"07:00", "hourlyEnd":"17:00", "currency":"€", "description":"Sixième description d'un chantier", "amount":23456.10, "DetailedPost":["radiateur", "Chaudière"]}
    ...
    #   response = requests.get(url, headers=headers, params={"action":"duplicatePost", "id":2})
      ...
      post3 = {'action':"validateMissionDate", "missionId": 3, "field":"date", "state":False, "date":f"2022-06-16"}
      post4 = {'action':"validateMissionDate", "missionId": 3, "field":"date", "state":True, "date":f"2022-06-19"}
